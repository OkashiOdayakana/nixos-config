...
let
  ...
  # use the first 7 characters of the TheEssem commit hash as version string
  version = builtins.substring 0 7 versionData.rev;

  # the patched TheEssem source
  src = callPackage ./source.nix { };

  # ruby gems, built from `gemset.nix`, which is generated by bundix in `update.sh` from the source Gemfile
  mastodonGems = bundlerEnv {
    name = "TheEssem-gems-${version}"; # bundlerEnv breaks when pname is set instead
    inherit version;
    ruby = ruby;
    gemset = ./gemset.nix;
    gemdir = src;
  ...
  mastodonModules = stdenv.mkDerivation {
    ...
    */
    ...
    buildPhase = ''
      ...
      # see: https://code.hackerspace.pl/ar/nibylandia/src/commit/7bbb773554204026644fb98c9463fd15726976e9/pkgs/TheEssem/modules.nix#L52
  ...
  # the actual main TheEssem package
